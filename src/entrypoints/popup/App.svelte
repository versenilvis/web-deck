    ...
    <header class="apple-header">
      ...
      <div class="header-actions">
        <button
          ...
          title={lastSyncedAt ? `Updated: ${formatUsDateTime(lastSyncedAt)} • Click to update` : 'Update from Source'}
        >
          <svg class="action-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
    ...
    {:else if currentTab === 'github'}
      ...
      <div class="apple-group">
        ...
        <div class="rows">
          <div class="item-row">
            <div class="item-info">
              <div class="item-name">Repository</div>
              <div class="item-caption">Source code, releases & issues</div>
            </div>
            <button
              type="button"
              class="action-link"
